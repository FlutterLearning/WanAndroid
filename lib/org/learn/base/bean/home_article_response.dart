class ArticleResponse {
  ...
  ArticleResponse({this.curPage, this.datas, this.offset, this.over, this.pageCount, this.size, this.total});

  ArticleResponse.fromJson(Map<String, dynamic> json) {
    curPage = json['curPage'];
    if (json['datas'] != null) {
      datas = new List<ArticleDetailData>();
      json['datas'].forEach((v) {
        datas.add(new ArticleDetailData.fromJson(v));
      });
    }
    offset = json['offset'];
    over = json['over'];
